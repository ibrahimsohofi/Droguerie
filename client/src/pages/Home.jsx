...
const Home = () => {
  ...
  // Enhanced hero section with Moroccan-inspired design
  const HeroSection = () => (
    <div className="relative bg-gradient-to-br from-brand-teal-50 via-white to-brand-amber-50 py-20 px-4 overflow-hidden moroccan-pattern">
      {/* Decorative elements */}
      <div className="absolute top-10 left-10 w-20 h-20 bg-brand-teal-200 rounded-full opacity-20 animate-float"></div>
      <div className="absolute bottom-10 right-10 w-32 h-32 bg-brand-amber-200 rounded-full opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
      ...
      <div className="max-w-7xl mx-auto text-center">
        <div className="animate-fade-in">
          ...
          <p className={`text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto ${isRTL ? 'font-arabic' : ''}`}>
            {language === 'ar'
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 card-elegant">
              <div className="text-3xl font-bold text-brand-teal-700 mb-2">500+</div>
              <div className="text-gray-600 text-sm">
                {language === 'ar' ? 'منتج' : language === 'fr' ? 'Produits' : 'Products'}
              </div>
            </div>
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 card-elegant">
              <div className="text-3xl font-bold text-brand-terracotta-700 mb-2">15+</div>
              <div className="text-gray-600 text-sm">
                {language === 'ar' ? 'سنة خبرة' : language === 'fr' ? 'Années d\'expérience' : 'Years Experience'}
              </div>
            </div>
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 card-elegant">
              <div className="text-3xl font-bold text-brand-amber-600 mb-2">10K+</div>
              <div className="text-gray-600 text-sm">
                {language === 'ar' ? 'عميل راضي' : language === 'fr' ? 'Clients satisfaits' : 'Happy Customers'}
              </div>
            </div>
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 card-elegant">
              <div className="text-3xl font-bold text-brand-teal-700 mb-2">24/7</div>
              <div className="text-gray-600 text-sm">
