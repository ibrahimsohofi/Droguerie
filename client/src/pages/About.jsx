...
const About = () => {
  ...
  const content = {
    ar: {
      title: 'من نحن',
      subtitle: 'تعرف على قصة دروغري جمال',
      hero: {
        title: 'متجركم المفضل منذ أكثر من 15 سنة',
        description: 'نحن في دروغري جمال نفخر بخدمة العائلات المغربية منذ عام 2009، نقدم أجود المنتجات للعناية الشخصية والمنزلية بأسعار تنافسية وخدمة عملاء ممتازة.'
      },
      story: {
        title: 'قصتنا',
        content: [
          'بدأت رحلة دروغري جمال في عام 2009 كمتجر صغير في قلب الدار البيضاء، بحلم بسيط وهو تقديم منتجات عالية الجودة بأسعار معقولة لجميع أفراد المجتمع.',
      ...
      contact: {
        ...
        info: [
          ...
          },
          {
            ...
            content: 'contact@drogueriejamal.ma'
          },
          {
    ...
    fr: {
      ...
      subtitle: 'Découvrez l\'histoire de Droguerie Jamal',
      hero: {
        title: 'Votre magasin de confiance depuis plus de 15 ans',
        description: 'Chez Droguerie Jamal, nous sommes fiers de servir les familles marocaines depuis 2009, en offrant les meilleurs produits de soins personnels et ménagers à des prix compétitifs avec un service client exceptionnel.'
      },
      story: {
        title: 'Notre histoire',
        content: [
          'L\'aventure de Droguerie Jamal a commencé en 2009 comme un petit magasin au cœur de Casablanca, avec un rêve simple : offrir des produits de haute qualité à des prix abordables pour tous les membres de la communauté.',
